...
use beibei\service\elasticsearch\index\ShowItemMizheIndexService;


class Itemshow_mizhe_controller extends Task_base {
    ...
    public function __construct() {
        // 设置当前索引脚本日志文件名
        $this->log_file_name = ShowItemMizheIndexService::$_ES_INDEX_LOG_NAME;
        parent::__construct();
    }
    ...
    public function execute() {
        ...
        // 实例化索引 Service
        $ShowItemMizheIndexService = ShowItemMizheIndexService::get_instance();

        // 创建一个新索引
        $createRes = $ShowItemMizheIndexService->createIndex();
        ...
        // 索引数据
        $_loop = $ShowItemMizheIndexService->buildDataToEs($this->last_id, self::$PAGE_NUM);
        $this->last_id = $ShowItemMizheIndexService->getLastId();
        ...
        // 创建别名，让新索引提供服务
        $setRes = $ShowItemMizheIndexService->setAlias();
        ...
        // 删除旧索引
        $delres = $ShowItemMizheIndexService->deleteIndex();
