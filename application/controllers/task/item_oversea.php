...
use beibei\service\elasticsearch\index\OverseaItemIndexService;


class Item_oversea_controller extends Task_base {
    ...
    public function __construct() {
        // 设置当前索引脚本日志文件名
        $this->log_file_name = OverseaItemIndexService::$_ES_INDEX_LOG_NAME;
        parent::__construct();
    }
    ...
    public function execute() {
        ...
        // 实例化索引 Service
        $ShowItemIndexService = OverseaItemIndexService::get_instance();
