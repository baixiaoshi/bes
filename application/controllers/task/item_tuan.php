...
use beibei\service\elasticsearch\index\TuanItemIndexService;


class Item_tuan_controller extends Task_base {
    ...
    public function __construct() {
        // 设置当前索引脚本日志文件名
        $this->log_file_name = TuanItemIndexService::$_ES_INDEX_LOG_NAME;
        parent::__construct();
    }
    ...
    public function execute() {
        ...
        // 实例化索引 Service
        $ShowItemIndexService = TuanItemIndexService::get_instance();
